  ...
  return (
    ...
    <div sx={{  position: 'relative', padding: '1em'}}> 
      ...
      <div sx={{variant: 'currTemp.row2' }}> 
        <div sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center',margin: '1em' }}>
          <FontAwesomeIcon
        ...
        <div sx={{display: 'flex', flexDirection: ['column', 'row', 'row'], alignItems: 'center', ul: {alignSelf: 'baseline', margin: 0, padding: [0,'20px','20px']}}}>
        <ul>
